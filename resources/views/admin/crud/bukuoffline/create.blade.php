    ...
    <div class="center">
        <div class="col-sm-15">
            <div class="page-header-title">
                <h4 class="pull-left page-title"> Tambah Buku Offline</h4>
                <ol class="breadcrumb pull-right">
                    <li class="active">Tambah Buku Offline</li>
                </ol>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <a href="{{ route('admin.bukuoffline.index') }}"class="btn btn-primary mb-3">Kembali</a>
            </form>
          </div>
      </div>
  </div>
