                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="nisn" value="{{ $users->nisn }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="kelas" value="{{ $users->kelas }}"
                                    id="formGroupExampleInput2" placeholder="Masukan Kelas">
                            </div>
                            <br>
                            <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Jurusan</label>
                                <input type="text" class="form-control" name="jurusan" value="{{ $users->jurusan }}"
