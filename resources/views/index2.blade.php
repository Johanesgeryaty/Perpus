        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="gambar">
                        <img class="img-" src="{{asset('assets/images/coverbuku.jpg')}}" alt="">
                    ...
                    <div class="text">
                        <div class="judul-buku">Judul Buku</div>
                        <li>
                            Genre: apa ya?
                        </li>
                        <li>
                    ...
                    <h5 >Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum vel impedit ea dolores. Architecto a doloremque nisi quibusdam culpa atque nobis, veniam voluptatem dolorem reiciendis praesentium, aperiam sunt consectetur magnam.</h5>
                </div>
                </div>
            </div>
            <a href="" class="btn btn-primary" style="margin: 5px;"><i class="bi bi-box-arrow-left"></i> Kembali</a>
